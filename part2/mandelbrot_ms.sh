...
#echo "*** np =1 ***"
#mpirun -np 1 ./mandelbrot_ms 1000 1000
echo "*** np =2 ***"
mpirun -np 2 ./mandelbrot_ms 4096 4096
echo "*** np =4 ***"
mpirun -np 4 ./mandelbrot_ms 4096 4096
echo "*** np =8 ***"
mpirun -np 8 ./mandelbrot_ms 4096 4096
echo "*** np =16 ***"
mpirun -np 16 ./mandelbrot_ms 4096 4096
echo "*** np =32 ***"
mpirun -np 32 ./mandelbrot_ms 4096 4096
echo "*** np =64 ***"
mpirun -np 64 ./mandelbrot_ms 4096 4096
